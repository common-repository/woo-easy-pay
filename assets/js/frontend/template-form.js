jQuery(function($) {
	...
	var worldpay = {
		...
		init : function() {
			...
			$(document.body).on('change', '#online_worldpay_save_cc_key', this.initialize_card_frame);
		...
		get_card_template_attribs : function() {
			var attribs = {
				...
				display : 'inline',
				reusable : worldpay.vars.reusable === "1" || $('#online_worldpay_save_cc_key').is(':checked'),
				type : 'card',
				templateOptions: {
					dimensions: {
						width: false,
