...
class WC_Worldpay_Query {
	...
	public function __construct() {
		...
		// commented out in 2.0.3 in favor of using standard url's. Some merchants have issues with pretty
		// permalinks based on settings, server url re-write conditions etc.
