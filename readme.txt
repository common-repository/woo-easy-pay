...
of eCommerce sites. PHP version 5.4 and greater is recommended.
...
== Changelog ==
= 2.0.6 = 
* Updated - Admin messaging on settings pages.
= 2.0.5 = 
* Fixed - 3DS redirect when user creates account on checkout page.
* Fixed - shopper IP address on pay for order page.
= 2.0.4 = 
* Added rounding to recurring payment total to prevent json parse error when floats are not handled
= 2.0.3 = 
* Updated - WC 3.6.3
* Updated - 3DS and PayPal redirect URL use regular query parameters now instead of pretty url. Better compatability with permalinks
* Added - Credit card save option on checkout page
= 2.0.2 = 
* Updated - localized params triggered by wp_print_scripts now
* Updated - Card svg's transparent
* Fixed - WC 3.6 issue with saved cards dropdown
= 2.0.1 = 
