...
<div class="worldpay-simple-form-container">
	...
	<?php if($gateway->display_save_cc()):?>
	<label><?php _e('Save', 'worldpay')?></label>
	<div class="simple-row save-cc">
		<input type="checkbox" id="<?php echo $gateway->save_cc_key?>" name="<?php echo $gateway->save_cc_key?>"/>
	</div>
	<?php endif;?>
	<?php endif;?>
</div>